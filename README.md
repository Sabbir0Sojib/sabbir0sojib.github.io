...
**Add a map.** Upload the image to `assets/img/work/`, then in `gallery.html` copy one `<figure class="shot">` block and change the image, title, text and `data-cat` (hazard, water, land or city).
